...
- **No pagination on `search_issues`.** Only `maxResults` (default 20) is honoured; the agent never iterates pages. For large projects this means the LLM only sees the first page.
